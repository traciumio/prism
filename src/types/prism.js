...
export const surfaces = [
    { id: "runtime", label: "Runtime Studio", caption: "UEF sessions from Tracium Engine" },
    { id: "architecture", label: "Architecture Lens", caption: "UGF topology from Atlas" },
];
export const lenses = [
    { id: "debug", label: "Debug Truth", caption: "Expose precise frames, refs, and transitions" },
    { id: "learn", label: "Learning Lens", caption: "Keep the same signal, but explain it more gently" },
];
